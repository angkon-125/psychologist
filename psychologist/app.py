...
try:
    ...
    print("Voice output system initialized — single local voice locked")
except Exception as e:
    print(f"Voice output system not available: {e}")
...
try:
    ...
    print(f"Voice input system not available: {e}")
...
try:
    ...
    print("Voice emotion components initialized")
except Exception as e:
    print(f"Voice emotion components not available: {e}")
    ...
    def voice_output_status():
        ...
        return jsonify({
            **tts_manager.get_voice_status(),
            "activity_log": current_activity_log[-20:] if current_activity_log else [],
        })
